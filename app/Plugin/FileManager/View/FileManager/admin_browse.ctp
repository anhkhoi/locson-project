...
<li>
<?php
echo $this->FileManager->link(__('Upload here'), array('controller' => 'file_manager', 'action' => 'upload'), $path
);
?>
</li>
<li>
    <?php
    echo $this->FileManager->link(__('Create directory'), array('controller' => 'file_manager', 'action' => 'create_directory'), $path
    );
    ?>
</li>
<li>
    <?php
    echo $this->FileManager->link(__('Create file'), array('controller' => 'file_manager', 'action' => 'create_file'), $path
    );
    ?>
</li>
    <?php $this->end(); ?>
